...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--json_path",
        type=Path,
        default=Path(__file__).resolve().parent / "old_experiments" / "all_generated_heuristics.json",
        help="Path to JSON file containing items with heuristic_code.",
    )
    parser.add_argument(
        "--out_dir",
        type=Path,
        default=Path(__file__).resolve().parent / "old_experiments" / "heuristic_analysis",
